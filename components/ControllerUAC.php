    ...
    public function beforeAction($action) {
	    ...
	    $sql = "    SELECT DISTINCT a.accessID,b.node
			...
			(
				...
				FROM ms_useraccess
				UNION ALL
				SELECT accessID, 'Lists' AS 'action'
				FROM ms_useraccess
				UNION ALL
				SELECT accessID, 'Addbrowse' AS 'action'
				FROM ms_useraccess
				UNION ALL
				SELECT accessID, 'printPage' AS 'action'
				FROM ms_useraccess    
				UNION ALL                                
				SELECT accessID, 'browsedelete' AS 'action'
				FROM ms_useraccess     
				UNION ALL
				SELECT accessID, 'Bankdescription' AS 'action'
				FROM ms_useraccess 
				UNION ALL
				SELECT accessID, 'description' AS 'action'
				FROM ms_useraccess   
				UNION ALL
				SELECT accessID, 'get-image' AS 'action'
				FROM ms_useraccess   
				UNION ALL
				SELECT accessID, 'upload' AS 'action'                        
				FROM ms_useraccess
				UNION ALL
				SELECT accessID, 'reprocess' AS 'action'                        
				FROM ms_useraccess
				UNION ALL
				SELECT accessID, 'close' AS 'action'                        
				FROM ms_useraccess
				UNION ALL
				SELECT accessID, 'get-position' AS 'action'                        
				FROM ms_useraccess
					UNION ALL
				SELECT accessID, 'save' AS 'action'                        
				FROM ms_useraccess
				UNION ALL
				SELECT accessID, 'RemoveImage' AS 'action'                        
				FROM ms_useraccess 
				UNION ALL
				SELECT accessID, 'generate-schedule' AS 'action'                        
				FROM ms_useraccess 
				UNION ALL
				SELECT accessID, 'report-payroll-draft-all' AS 'action'                        
				FROM ms_useraccess 
				UNION ALL
				SELECT accessID, 'report-payroll-draft' AS 'action'                        
				FROM ms_useraccess 
				UNION ALL
