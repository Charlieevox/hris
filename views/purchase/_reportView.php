...
<div class="wrap" style="font-size: 12px !important;">
    <div>
        ...
        <div style="margin-top: 10px; text-align: center; font-size: 16px;"><b>PURCHASE ORDER REPORT</b></div>

        <div style="margin-top: 10px; padding: 10px 10px 10px 10px;">
            <div style="float:left; width: 70%;">
               <div>
                    <div style="width: 115px; float: left;">PURCHASE NUMBER</div>
                    <div style="display:block; float: left;">: <?= $model->purchaseNum ?></div>
                    <div style="clear: both;"></div>
                </div>
                <div>
                    <div style="width: 115px; float: left;">DATE</div>
                    <div style="display:block; float: left;">: <?= $model->purchaseDate ?></div>
                    <div style="clear: both;"></div>
                </div>
                <div>
        ...
        <div style="padding: 10px 10px 10px 10px;">
            <div style="margin-top: 10px;"><b><i>PURCHASE ORDER DETAIL</i></b></div>
                <div style="border-bottom: #000 solid 1px; margin: 10px 1% 0px 1%; padding-bottom: 10px;">
                    ...
                    <div style="float:left; width: 15%; text-align: left; font-size: 10px;">Barcode Number</div>
                    <div style="float:left; width: 15%; text-align: left; font-size: 10px;">Product Name</div>
                    <div style="float:left; width: 5%; text-align: left; font-size: 10px;">Unit</div>
                ...
                <?php 
                    $i = 1;
                    foreach ($model->joinPurchaseOrderDetail as $row) { 
                        ?>
                        <div style="margin: 5px 1%; ">
                            <div style="float:left; width: 5%; text-align: center; font-size: 10px;"><?= $i ?></div>
                            <div style="float:left; width: 15%; font-size: 10px;"><?= $row['barcodeNumber'] ?>&nbsp;</div>
                            <div style="float:left; width: 15%; font-size: 10px;"><?= $row['productName'] ?>&nbsp;</div>
                            <div style="float:left; width: 5%; font-size: 10px;"><?= $row['uomName'] ?>&nbsp;</div>
