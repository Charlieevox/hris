...
$(document).ready(function () {
	...
	$('.confirmationDateInput').keypress(function(e) {
		if(e.which == 13) {
			$('.methodIDInput').focus();
		}
	});
	
	$('.methodIDInput').keypress(function(e) {
		if(e.which == 13) {
			$('.confirmationInput-1').focus();
		}
	});
	
		$('.confirmationInput-1').keypress(function(e) {
		if(e.which == 13) {
			$('.confirmationInput-2').focus();
		}
	});
	
		$('.confirmationInput-2').keypress(function(e) {
		if(e.which == 13) {
			$('.confirmationInput-3').focus();
		}
	});
	
		$('.confirmationInput-3').keypress(function(e) {
		if(e.which == 13) {
			$('.confirmationInput-4').focus();
			$('.confirmationInput-4').select();
		}
	});
	
	$('.confirmationInput-4').keypress(function(e) {
		if(e.which == 13) {
			$('.btnAdd').focus();
		}
	});
	...
	$('.btnSave').keypress(function(e) {
		...
		if(accountName=="" || accountName==undefined){
			bootbox.alert("Fill Account Name");
			$('.confirmationInput-3').focus();
			return false;
		}
