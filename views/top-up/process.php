...
$this->title = 'Process Confirmation';
...
<div class="process-index">
    <?= GridView::widget([
	    ...
	    'toolbar' => [
	        [
                'content'=>
                Html::a('<i class="glyphicon glyphicon-repeat"></i>', ['process'], [
        ...
        'columns' => [
			...
			// [
			// 'attribute' => 'actionPayment',
			// 'value' => function ($data) {
					// return $data->actionPayment;
				// },
			// 'filter' => ['Paid','Unpaid'],
			// 'filterInputOptions' => [
					// 'prompt' => '- All -'
