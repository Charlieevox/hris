    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
			 ...
			 [
                'attribute' => 'incomeAccount',
                'value' => function ($data) {
                    return $data->coaNo->description;
                },
                'filter' => ArrayHelper::map(MsCoa::find()->where('coaLevel = 4 AND coaNo LIKE "4%"')->orderBy('description')->all(), 
				'coaNo', 'description'),
				'filterInputOptions' => [
					'prompt' => '- All -'
				]
            ...
            ['attribute' => 'status',
               ...
               'filter' => ArrayHelper::map(MsStatus::find()->where('statusKey = "Cash In"')->orderBy('statusID')->all(), 
